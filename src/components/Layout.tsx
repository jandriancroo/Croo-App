...
const [updateAvailable, setUpdateAvailable] = useState<boolean | null>(null); // null = not checked yet
  ...
  return <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className={`container max-w-7xl mx-auto flex-1 px-safe pb-0 relative ${isMobile ? `pt-[calc(env(safe-area-inset-top)+3.25rem)] ${location.pathname.includes('/count/') ? 'pb-4' : 'pb-24'}` : 'pt-1 py-8 pb-8'}`}>
        {children}
      </main>
