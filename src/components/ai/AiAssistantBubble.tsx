    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="crooai-orb fixed bottom-24 left-4 z-50 h-14 w-14 rounded-full shadow-xl hover:shadow-2xl hover:scale-110 transition-all flex items-center justify-center md:bottom-8"
