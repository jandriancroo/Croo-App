  ...
  return (
    <AnimatePresence>
      {expanded && (
        ...
        >
            <div ref={panelRef} className="relative w-[min(22rem,calc(100vw-1.5rem))] sm:w-72 bg-[hsl(var(--ovation-panel))] text-[hsl(var(--ovation-panel-foreground))] border border-[hsl(var(--ovation-panel-border))] rounded-2xl shadow-lg mt-2">
            {/* Tail pointing up to the Ovation pill in the header */}
            {tailLeftPct !== null && (
              <div
                aria-hidden
                className="absolute -top-1.5 w-3 h-3 rotate-45 bg-[hsl(var(--ovation-panel))] border-l border-t border-[hsl(var(--ovation-panel-border))]"
                style={{ left: `${tailLeftPct}%`, transform: 'translateX(-50%) rotate(45deg)' }}
              />
            )}

            {/* Header */}
            <div className="px-4 sm:px-3 pt-3 sm:pt-2.5 pb-3 sm:pb-2 flex items-center justify-between gap-3 border-b border-[hsl(var(--ovation-panel-border))]/70">
              <div className="flex items-center gap-2.5 min-w-0">
                ...
                <div>
                  ...
                  <p className="text-xs sm:text-[10px] text-[hsl(var(--ovation-panel-muted))] leading-tight">
              ...
              <div className="flex items-center gap-2.5 shrink-0">
                ...
                <div className="flex items-center gap-1.5 text-[hsl(var(--ovation-panel-muted))]">
            ...
            {reviewsWithFeedback.length > 0 ? (
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <div className="flex items-center gap-2.5 mb-2 sm:mb-1 flex-wrap">
                      ...
                      <span className="text-sm sm:text-[10px] font-semibold text-[hsl(var(--ovation-panel-foreground))] truncate max-w-[11rem] sm:max-w-none">
                     ...
                     <p className="text-base sm:text-[11px] font-medium text-[hsl(var(--ovation-panel-foreground))] leading-relaxed sm:leading-snug line-clamp-4 sm:line-clamp-3">
                      ...
                      <button
                        ...
                        className={cn(
                          'h-2 w-2 sm:h-1 sm:w-1 rounded-full transition-all',
                           idx === reviewIndex ? 'bg-primary w-4 sm:w-2' : 'bg-[hsl(var(--ovation-panel-muted))]/35'
                        )}
              ...
              <div className="px-4 sm:px-3 py-4 sm:py-3">
                 <p className="text-base sm:text-[11px] text-[hsl(var(--ovation-panel-muted))] italic">
