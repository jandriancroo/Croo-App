  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <button className="flex items-center gap-1.5 px-3 py-1 rounded-b-xl bg-muted/80 shadow-sm hover:bg-muted transition-colors border border-t-0 border-border/30">
