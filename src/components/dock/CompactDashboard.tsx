          ...
          <div className="px-4 pb-safe overflow-y-auto" style={{ maxHeight: 'calc(75vh - 60px)' }}>
            ...
            <div className="flex items-start gap-3 mb-4">
              ...
              {(() => {
                ...
                return (
                  <div className="flex items-start gap-2 mr-10 shrink-0">
                    {teaching && (
                      <div className="relative mt-1 animate-scale-in">
                        <div className="relative px-3 py-2 rounded-2xl bg-accent-foreground text-accent shadow-lg max-w-[160px]">
                          ...
                          {/* Speech bubble tail pointing right toward the orb */}
                          <div className="absolute top-1/2 -right-1.5 -translate-y-1/2 w-3 h-3 rotate-45 bg-accent-foreground" />
                        </div>
                      </div>
                    )}
                    <TheoOrb
