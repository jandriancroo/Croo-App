                  ...
                  <div className="p-3">
                    ...
                    <div className="flex items-center justify-center gap-2">
                      {!isViewOnly && (
                        <button
                          type="button"
                          className="h-12 w-12 flex items-center justify-center rounded-md bg-destructive text-destructive-foreground hover:bg-destructive/80 active:scale-95 transition-all"
