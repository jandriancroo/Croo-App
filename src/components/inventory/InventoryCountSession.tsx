                        ...
                        {configs.map((cfg) => {
                          ...
                          return (
                            <div key={cfg.pack_config_id}>
                              ...
                              <div className={cn("grid", laneCount === 3 ? "grid-cols-3 gap-1.5" : laneCount === 2 ? "grid-cols-2 gap-2" : "grid-cols-1 gap-2")}>
                                {legLanes.showCases && (
                                  <div>
                                    ...
                                    <div className="flex items-center rounded-lg overflow-hidden border border-foreground/20">
                                      {!isViewOnly && (
                                        <button type="button" className="relative h-8 w-6 flex items-center justify-center text-muted-foreground active:bg-muted transition-colors flex-shrink-0" onClick={() => updateCases(legKeyUi, -1)}>
                          ...
                          <span aria-hidden="true" className="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 w-px h-1/2 bg-gradient-to-b from-transparent via-foreground/20 to-transparent" />
                                      ...
                                      <input
                                        ...
                                        disabled={isViewOnly}
                                        className="flex-1 text-center text-lg font-bold leading-none text-foreground tabular-nums bg-transparent outline-none min-w-0 px-2 sm:text-xl sm:px-3"
                                      />
                                      {!isViewOnly && (
                                        <button type="button" className="relative h-8 w-6 flex items-center justify-center text-muted-foreground active:bg-muted transition-colors flex-shrink-0" onClick={() => updateCases(legKeyUi, 1)}>
                          ...
                          <span aria-hidden="true" className="pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 w-px h-1/2 bg-gradient-to-b from-transparent via-foreground/20 to-transparent" />
                                ...
                                {legLanes.showInnerPacks && (
                                  <div>
                                    ...
                                    <div className="flex items-center rounded-lg overflow-hidden border border-foreground/20">
                                      {!isViewOnly && (
                                        <button type="button" className="relative h-8 w-6 flex items-center justify-center text-muted-foreground active:bg-muted transition-colors flex-shrink-0" onClick={() => updateInnerPacks(legKeyUi, -1)}>
                                          <Minus className="h-2.5 w-2.5" strokeWidth={4} />
                          <span aria-hidden="true" className="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 w-px h-1/2 bg-gradient-to-b from-transparent via-foreground/20 to-transparent" />
                                        </button>
                                      )}
                          ...
                          <span aria-hidden="true" className="pointer-events-none absolute left-0 top-1/2 -translate-y-1/2 w-px h-1/2 bg-gradient-to-b from-transparent via-foreground/20 to-transparent" />
                                ...
                                {legLanes.showUnits && (
                                  <div>
                                    ...
                                    <div className="flex items-center rounded-lg overflow-hidden border border-foreground/20">
                                      {!isViewOnly && (
                                        <button type="button" className="relative h-8 w-6 flex items-center justify-center text-muted-foreground active:bg-muted transition-colors flex-shrink-0" onClick={() => updateUnits(legKeyUi, -1)}>
                                          <Minus className="h-2.5 w-2.5" strokeWidth={4} />
                          <span aria-hidden="true" className="pointer-events-none absolute right-0 top-1/2 -translate-y-1/2 w-px h-1/2 bg-gradient-to-b from-transparent via-foreground/20 to-transparent" />
                                        </button>
                                      )}
