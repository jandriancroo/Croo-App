...
import { MapPin, Package, Loader2, Pencil, FlaskConical, EyeOff, Eye, AlertTriangle, ArrowRightLeft, ChevronDown, Settings2, MoveRight, X, Plus, RefreshCw, Link2, Tag, ListOrdered, Grid3X3 } from "lucide-react";
  ...
  return (
    ...
    <div className="space-y-6">
      ...
      {canEditRecipes && items && (() => {
        ...
        // Group recipes by storage location
            ...
            <CardContent className="p-4 space-y-3">
                ...
                return (
                  <div key={loc.id}>
                    ...
                    <div className="grid gap-1">
                      {locRecipes.map(renderRecipeRow)}
                    </div>
                  </div>
                );
              })}
              ...
              {unassignedRecipes.length > 0 && (
                <div>
                  ...
                  <div className="grid gap-1">
                    {unassignedRecipes.map(renderRecipeRow)}
                  </div>
                </div>
              )}
            </CardContent>
