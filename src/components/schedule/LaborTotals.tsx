...
export function LaborTotals({
  ...
  return <div className="text-xs min-w-[700px] relative">
        ...
        <div className="border border-border rounded-lg bg-card shadow-md overflow-hidden animate-accordion-down mb-2">
          ...
          <div className="grid grid-cols-[110px_repeat(7,1fr)] md:grid-cols-[130px_repeat(7,1fr)] lg:grid-cols-[180px_repeat(7,1fr)] xl:grid-cols-[200px_repeat(7,1fr)] gap-0 border-b border-border">
            ...
            {dailyTotals.map((day, index) => {
              ...
              return (
                <div key={index} className={`px-2 py-1 border-r border-border text-center flex items-center justify-center gap-1 ${isToday ? 'bg-primary/10 ring-2 ring-inset ring-primary/30' : ''}`}>
      ...
      <div className="grid grid-cols-[110px_repeat(7,1fr)] md:grid-cols-[130px_repeat(7,1fr)] lg:grid-cols-[180px_repeat(7,1fr)] xl:grid-cols-[200px_repeat(7,1fr)] gap-0 border-b border-border">
        ...
        return <div key={index} className={`px-2 py-1 border-r border-border text-center flex items-center justify-center ${isToday ? 'bg-primary/10 ring-2 ring-inset ring-primary/30' : ''}`}>
      ...
      <div className="grid grid-cols-[110px_repeat(7,1fr)] md:grid-cols-[130px_repeat(7,1fr)] lg:grid-cols-[180px_repeat(7,1fr)] xl:grid-cols-[200px_repeat(7,1fr)] gap-0">
        ...
        {weekDays.map((day, index) => {
          ...
          const bgClass = isToday ? 'bg-primary/10 ring-2 ring-inset ring-primary/30' :
