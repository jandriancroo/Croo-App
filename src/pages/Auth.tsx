...
export default function Auth() {
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center p-4 gap-6 relative z-10 bg-gradient-to-br from-background via-primary/5 to-accent/10">
