...
const STYLES: Record<Style, {
  ...
  frosted: {
    name: "A · Frosted",
    blurb: "Translucent card with heavy blur and hairline border. Closest to Instagram.",
    dock: "bg-card/60 backdrop-blur-2xl border border-border/40 shadow-lg",
    iconActive: "text-foreground",
    iconIdle: "text-muted-foreground/60",
    smartDock: "bg-card/70 backdrop-blur-2xl border border-border/40 shadow-lg",
    saveBtn: "bg-primary text-primary-foreground",
    micBtn: "bg-muted/50 border border-border/40 text-foreground",
    accent: "text-primary",
  },
  solid: {
    name: "B · Solid Card",
    blurb: "Opaque card surface, no blur, soft outer shadow. Crisper and more 'app-like'.",
    dock: "bg-card border border-border shadow-md",
    iconActive: "text-foreground",
    iconIdle: "text-muted-foreground",
    smartDock: "bg-card border border-border shadow-md",
    saveBtn: "bg-primary text-primary-foreground",
    micBtn: "bg-muted border border-border text-foreground",
    accent: "text-primary",
  },
  glow: {
    name: "C · Accent Glow",
    blurb: "Translucent card with an accent-colored glow on active icon + Theo orb.",
    dock: "bg-card/70 backdrop-blur-xl border border-border/40 shadow-[0_0_40px_hsl(var(--accent)/0.25)]",
    iconActive: "text-accent drop-shadow-[0_0_8px_hsl(var(--accent)/0.9)]",
    iconIdle: "text-muted-foreground/60",
    smartDock: "bg-card/75 backdrop-blur-xl border border-accent/30 shadow-[0_0_50px_hsl(var(--accent)/0.25)]",
    saveBtn: "bg-accent text-accent-foreground shadow-[0_0_20px_hsl(var(--accent)/0.5)]",
    micBtn: "bg-muted/40 border border-accent/40 text-accent",
    accent: "text-accent",
  },
};
