    ...
    <Layout>
      {isMobile ? (
        ...
        >
          ...
          {(isAdmin || isManager) && (
            <div className="fixed bottom-0 left-0 right-0 bg-card border-t-2 border-border shadow-lg z-50 overflow-visible">
              <div className="container max-w-7xl mx-auto px-4 pt-8 pb-2 max-h-[40vh] overflow-y-auto overflow-x-hidden">
