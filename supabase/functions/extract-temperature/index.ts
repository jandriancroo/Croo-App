        ...
        messages: [
          ...
          },
          {
            ...
            content: [
              {
                type: "text",
                text: "What is the temperature reading on this thermometer? This may be a digital LCD stick thermometer or an analog round gauge thermometer. IMPORTANT: First zoom all the way into the display area. For stick thermometers: STEP 1 - Locate the Fahrenheit indicator which is a small degree symbol (°) with an 'F' below it in the TOP RIGHT corner of the LCD screen. This °F indicator establishes the correct orientation. If °F is not in the top right, the image is upside down or sideways - mentally rotate until °F is in the top right corner. STEP 2 - With correct orientation established (°F in top right), read the digit sequence LEFT TO RIGHT starting from the leftmost digit. The LCD uses SEVEN-SEGMENT DISPLAYS with illuminated bar segments forming each number. CRITICAL: Examine each digit individually and carefully count which segments are lit. Common patterns: '0' = 6 segments forming closed loop (all except middle bar), '1' = only 2 right vertical segments, '2' = 5 segments zigzag pattern, '3' = 5 segments on right side, '4' = 4 segments with open left side (top-left vertical, middle horizontal, and both right segments), '5' = 5 segments opposite of '2', '6' = 6 segments with top-right unlit, '7' = 3 top segments only, '8' = all 7 segments fully lit, '9' = 6 segments with bottom-left unlit. Read each digit sequentially from left to right. The digit after the decimal point is smaller but follows the same pattern. If tilted at an angle, rotate mentally until °F is top right, then read left to right. For round gauge thermometers: zoom in very close until the circular dial fills your view, then read where the needle points. CRITICAL: Round gauges have TWO rings - INSIDE ring is Celsius, OUTSIDE ring is Fahrenheit. You MUST read the OUTSIDE ring. Return only the numeric value (e.g., 38.5 or 40.7 or 165)."
              },
              {
                type: "image_url",
                image_url: {
