...
<table style="width:100%;max-width:640px;margin:0 auto;background:#fff;border-radius:24px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.06);">
  <tr><td style="background:linear-gradient(135deg,#0a7a8a,#0d5a65);padding:30px 40px;text-align:center;">
  ...
  <tr><td style="padding:30px 40px;">
    ...
    <div style="text-align:center;margin:28px 0;">
      <a href="${downloadUrl}" style="display:inline-block;background:linear-gradient(135deg,#f58220,#e06b10);color:#fff;text-decoration:none;padding:14px 32px;border-radius:10px;font-weight:600;">Download PDF</a>
    </div>
