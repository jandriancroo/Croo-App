...
-- Create the hourly sales pulse SQL function
...
BEGIN
  ...
  LOOP
    ...
    SELECT 
      COALESCE(sc.override_projection, sc.projected_sales, 0),
      COALESCE(sc.net_sales, 0),
      COALESCE(sc.living_projection, sc.override_projection, sc.projected_sales, 0)
