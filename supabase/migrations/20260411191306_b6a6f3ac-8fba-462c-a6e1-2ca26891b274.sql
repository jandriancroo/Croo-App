...
BEGIN
  ...
  -- Flush old Theo chat messages (keeps only today's)
  PERFORM public.cleanup_theo_chat_messages();

  -- Trigger vendor SKU health sync (brand-level, runs once per night)
  PERFORM net.http_post(
    url := 'https://lmodeiyrpwvgyqcvjkjr.supabase.co/functions/v1/vendor-sku-health-sync',
