...
BEGIN
  ...
  -- 2) Clone inventory_items VERBATIM (every column copied; only id, location_id,
  --    storage_location_id, and timestamps are remapped).
  WITH src AS (
  ...
  INSERT INTO public.inventory_counts (
    id, location_id, count_date, period_type, status, started_by, started_at,
    completed_by, completed_at, total_value, notes, created_at, updated_at,
  ...
  -- 6) Clone inventory_count_item_legs (verbatim snapshots)
